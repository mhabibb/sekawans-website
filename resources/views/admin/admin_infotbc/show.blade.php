  ...
  <article class="d-flex flex-column align-items-center justify-content-center border-top pt-4">
    ...
    <div class="body">
      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam, iusto distinctio dicta magnam sit incidunt
        ...
        necessitatibus harum sed inventore numquam asperiores, veniam labore adipisci iure illo suscipit sequi doloribus
      ...
      <p>Sequi vel ex iusto, fugit deserunt neque sit necessitatibus magnam nisi a fugiat magni perspiciatis nobis?
        Tempora incidunt dicta vero, voluptas reiciendis autem mollitia totam libero commodi minus expedita consequuntur
      ...
      <p>Repellat, molestias error, autem ipsa libero earum deserunt facere repellendus adipisci consequatur delectus
        quis eligendi suscipit optio ullam voluptatum amet quae. Deleniti, molestias recusandae. Quas asperiores libero
        quae perspiciatis facere ut tempore iste maiores porro possimus debitis, perferendis rem laudantium voluptates
        nisi eius ab? Modi quae rem soluta, repellendus architecto accusamus. Nihil, numquam itaque nam earum et porro.
      </p>
    </div>
  </article>
</section>
