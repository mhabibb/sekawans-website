                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="/admin/kegiatan/create" class="card-title">Buat Kegiatan Baru</a>
                        ...
                        <div class="card-body table-responsive p-0" style="height: 360px;">
                            <table class="table table-head-fixed text-nowrap table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>183</td>
                                        <td>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Possimus, consequatur?
                                        </td>
                                        <td>11-7-2014</td>
                                        <td>
                                            <a href="/admin/kegiatan/single_kegiatan" class="badge badge-success">Lihat</a>
