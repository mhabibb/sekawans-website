    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Edit Profil Organisasi</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
  ...
  <div class="container-fluid pb-5">
    <form action="">
      <div class="form-group mb-3">
        <label for="title" class="form-label col-12">Profil Sekawan'S TB Jember</label>
        <div class="custom-file mb-3 col-md-6">
          <input type="file" class="custom-file-input" id="profileImg" aria-describedby="inputGroupFileAddon01">
          <label class="custom-file-label" for="profileImg">Choose file</label>
        </div>
        <textarea class="form-control col-12" name="content" id="content"
      ...
      <div class="form-group mb-3 col-md-6">
        <label for="articleImg">Struktur Organisasi</label>
