        ...
        <div class="col-md-6">
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text" style="font-size: 16px; color: #666;">Keterangan mengenai dokumen 3. Dokumen ini misalnya berisi informasi penting mengenai topik tertentu.</p>
